use "/Users/pierredumontel/Desktop/Mag2/S2/Stata/Projet/life.dta", clear
...
twoway (connected pollution year if country =="IRL")(connected pollution year if country =="FIN") /// 
(connected pollution year if country =="MEX")(connected pollution  year if country =="CAN") /// 
(connected pollution  year if country =="PRT")(connected pollution year if country =="FRA"), ///  
